...
namespace SistemaDeVendasEX1
{
    class Tela
    {
        //Classe responsável por conter operações que interagem 
        //com o usuário no modo console
        ...
        public static void cadastrarPedido()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                int pos = Program.produtos.FindIndex(x => x.codigo == codProduto); // se ele não achar, retorna -1
                if (pos == -1)
                {
